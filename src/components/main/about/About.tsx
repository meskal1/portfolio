...
export const About = React.memo(() => {
  ...
  const onChangeContactField = (e: ChangeEvent<HTMLTextAreaElement>) => {
    ...
    validate.match(cyrillicChar) ? setFontSizeCyrillicContactField(s.fontSizeCyrillic) : setFontSizeCyrillicContactField('')
        ...
        <div className={s.about__container}>
          <div className={s.about__content}>
            ...
            <div className={s.about__text_container}>
              ...
              <AboutText
                canIStartTypingAboutText={canIStartTypingAboutText}
                textContent={aboutText}
                ivivtationAnimate={aboutTextCurrentLength}
              />
            </div>
            <div className={s.about__invitation_block}>
              <InvitationText canIStartAimateInvitationText={canIStartAimateInvitationText} />
              <a
                className={`${s.about__invitation_button} ${canIStartAimateButton}`}
                onAnimationEnd={onAnimationEnd}
                onClick={onClickHireButton}>
                HIRE ME
              </a>
            </div>
            {isOpen && (
              <Portal>
                <div className={s.hireModal} onClick={onClickOutOffModal}>
                  <form className={s.hire__form} action=''>
                    <span className={s.hire__text}>
                      Thank you, I appreciate your trust. You can contact me via{' '}
                      <a className={s.contactLinks} href='https://t.me/DaniilKalach' target='https://t.me/DaniilKalach'>
                        telegram
                      </a>{' '}
                    ...
                    <div className={s.hire__block_input}>
                      <input
                        className={`${s.hire__input_company_name} ${fontSizeCyrillicСompany} ${сompanyFieldErrorStyle}`}
                        id='companyName'
                        required
                        name='companyName'
                        autoComplete='off'
                    ...
                    <div className={s.hire__block_input}>
                      <textarea
                        required
                        className={`${s.hire__textarea} ${fontSizeCyrillicContactField} ${сontactFieldErrorStyle}`}
                        name='message'
                        id='message'
                        value={contactField}
                    ...
                    <button
                      className={`${s.hire__form_button} ${buttonErrorStyle}`}
                      type='submit'
                      form='hireMe'
                      onClick={onClickModalButton}
                      onAnimationEnd={onAnimationButtonErrorEnd}>
                      START PARTNERSHIP
                    </button>
                  </form>
                </div>
